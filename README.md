...
Desarrollador Full-Stack y soporte de infraestructura TI. Actualmente en **ISTHO S.A.S.**, donde combino el desarrollo de **CenthriX** (CRM/WMS para logística, transporte y almacenamiento) con el soporte tecnológico de la empresa.
...
- 🖥️ Además del desarrollo, apoyo la infraestructura tecnológica de la empresa: administración de Microsoft 365 (correo corporativo, licencias, autenticación), mantenimiento de equipos y soporte de red (Access Points, racks, CCTV).
...
- Administración del centro de administración de **Microsoft 365**: cuentas de correo corporativo, gestión de licencias y configuración de métodos de autenticación.
- Mantenimiento preventivo y correctivo de equipos de cómputo.
- Soporte básico en infraestructura de red: puntos de acceso (AP), racks y sistemas de CCTV.
...
- Integración con un WMS externo mediante arquitectura dual de sincronización (API REST + consultas directas a base de datos), resolviendo desafíos de consistencia entre entornos de producción y pruebas.
...
- Administración de cuentas de correo corporativo, licencias y métodos de autenticación en Microsoft 365.
